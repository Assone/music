 ...
 * @param password 密码
 */
export const login = (account: string | number, password: string): Promise<IrLoginEmail> =>
  isString(account)
...
export const changePhone = (
  ...
  phone: number,
  area?: number,
) => http.post(AUTH.changePhone, { oldcaptcha: oldCaptcha, captcha, phone, ctcode: area });
