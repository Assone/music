<template>
  <div class="view-search-detail">
    <div :class="$style.row">
      <AppSection :class="$style.artist" v-if="artists.length !== 0">
      ...
      <AppSection :class="$style.album" v-if="albums.length !== 0">
    ...
    <AppSection v-if="songs.length !== 0">
    ...
    <AppSection v-if="playlists.length !== 0">
